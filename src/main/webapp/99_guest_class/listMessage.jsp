<%@page import="guest2.service.ListMessageService"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="guest2.model.*,guest.service.*" %>   
...
<%
	...
	ListMessageService service = ListMessageService.getInstance();	//싱글톤 // 서비스 단
	
		List <Message> mList = service.getMessageList();			//서비스 메서드호출
